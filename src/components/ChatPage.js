...
const ChatPage = () => {
  ...
  const handleSetup = async () => {
    ...
    try {
      const response = await axios.post('http://prat0-clarifapi.hf.space/setup', {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.post('http://prat0-clarifapi.hf.space/query', { query });
  ...
  useEffect(() => {
    const fetchChatHistory = async () => {
      try {
        const response = await axios.get('http://prat0-clarifapi.hf.space/chat-history');
